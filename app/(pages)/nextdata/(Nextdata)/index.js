    ...
    return (
        <div className="d-flex vh-100">
            ...
            <div className="d-none relative gradient-diagonal d-md-flex flex-column justify-content-center align-items-center p-5 w-75 h-100 text-white">
                <Image src={img1} width={59} height={59} alt="Author Image" className="img1" />
                <div className="img5">
                    <Image src={img5} width={59} height={59} alt="Logo" className="img5-1" />
                    <div className="img5-text">Inzaar.org</div>
                </div>
                <Image src={img2} width={59} height={59} alt="Author Image" className="img2" />
                <Image src={img3} width={59} height={59} alt="Author Image" className="img3" />
                <Image src={img4} width={59} height={59} alt="Author Image" className="img4" />
            </div>
            ...
            <div className="col-md-6 d-flex p-4 gap-0 align-items-center justify-content-center">
                <form className="w-100" style={{ maxWidth: "500px" }}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="education" placeholder="Enter your qualification" />
                    </div>
                    ...
                    {/* Religious Course */}
                    <div className="mb-3">
                        <label htmlFor="courseDetails" className="form-label text-black">Religious Course Details</label>
                        <textarea className="form-control" id="courseDetails" rows="2" placeholder="Enter details"></textarea>
                    </div>

                    {/* How did you hear about us */}
                    <div className="mb-3">
                        <label htmlFor="source" className="form-label text-black">How did you know about Inzaar/Course?</label>
                        <textarea className="form-control" id="source" rows="2" placeholder="Enter info"></textarea>
                    </div>
